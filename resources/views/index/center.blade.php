...
@section('content')
    ...
    <section class="content-header">
        {!! Breadcrumbs::render('index-home-center') !!}
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-sm-9 col-lg-10">
                ...
                <div class="panel panel-default">
                    ...
                    {!! Form::model($user, ['route' => ['home.center.update', $user],'class' => 'form-horizontal form-bordered', 'method' => 'patch', 'files' => true ]) !!}
                    ...
                    <div class="panel-body panel-body-nopadding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                {!! Form::text('name', old('name'), ['class' => 'form-control tooltips','data-toggle' => 'tooltip','data-trigger' => 'hover','disabled' => 'disabled','data-original-title' => '不可重复']) !!}
                            </div>
                        </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                ...
                                &nbsp;
                                <a href="{{ route('home.center') }}" class="btn btn-default">取消</a>
                            </div>
                        </div>
                    </div><!-- panel-footer -->
