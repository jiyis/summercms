...
@section('content')
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a href="javascript:;" data-toggle="modal" data-target="#create_group_modal"
                           class="btn btn-primary pull-right">新增组别</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body" style="padding:15px;">
                        ...
                        <div class="game-box">
                            <div class="game-header">
                                ...
                                <a class="btn btn-danger btn-xs pull-right" data-toggle="modal"
                                   data-target="#delete_group_modal" data-href="#" style="margin-left: 10px;"><i
                                            class="fa fa-times"></i></a>
                                <a href="javascript:;" class="btn btn-white btn-xs pull-right" data-toggle="modal"
                                   data-target="#edit_group_modal" style="margin-left: 10px;"><i
                                            class="fa fa-pencil"></i></a>
                                <a href="javascript:;" class="btn btn-success btn-xs pull-right" data-toggle="modal"
                                   data-target="#create_match_modal"><i class="fa fa-plus"></i></a>
                            </div>
                            <div class="game-body">
                                <table class="table table-striped table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <td>2017/01/04 13:59</td>
                                        <td>5:0</td>
                                        <td><span class="label label-info">当前比赛</span></td>
                                        <td>
                                            <a href="#" class="btn btn-white btn-xs" data-toggle="modal"
                                               data-target="#edit_match_modal">编辑</a>
                                            <a class="btn btn-danger btn-xs" data-href="#" data-toggle="modal"
                                               data-target="#delete_match_modal">删除</a>
                                        </td>
                                    </tr>
                                    </tbody>
                    ...
                    <div class="box-footer">
                        <a href="{{ route('admin.match.index') }}" class="btn btn-default pull-right"
                           style="margin-left: 15px;">取 消</a>
                        &nbsp;&nbsp;
    ...
    <div class="modal fade" tabindex="-1" id="edit_group_modal" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.match.create') }}" method="POST">
    ...
    <!--删除组别-->
    <div class="modal fade" tabindex="-1" id="delete_group_modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="fa fa-trash"></i> 确定要删除该组别吗?</h4>
                </div>
                <div class="modal-footer">
    ...
    <!--删除比赛-->
    <div class="modal fade" tabindex="-1" id="delete_match_modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="fa fa-trash"></i> 确定要删除该比赛吗?</h4>
                </div>
                <div class="modal-footer">
                    <form action="#" id="delete_form" method="POST">
                        <input type="hidden" name="_method" value="DELETE">
